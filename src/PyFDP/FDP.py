...
class FDP:
    ...
    def SetBreakpoint(self, CpuId, BreakpointType, BreakpointId, BreakpointAccessType, BreakpointAddressType, BreakpointAddress, BreakpointLength):
        BreakpointId = self.fdpdll.FDP_SetBreakpoint(self.pFDP, c_uint32(CpuId), c_uint16(BreakpointType), c_uint8(BreakpointId), c_uint16(BreakpointAccessType), c_uint16(BreakpointAddressType), c_uint64(BreakpointAddress), c_uint64(BreakpointLength))
        if BreakpointId >= 0:
            return BreakpointId
        return None
...
if __name__ == '__main__':
    ...
    #fdp.SetBreakpoint(CPU0, FDP_PAGEHBP, 0, FDP_EXECUTE_BP, FDP_VIRTUAL_ADDRESS, KiSystemCall64, 1)
